      ...
      child: Column(
        ...
        children: [
          ...
          _buildExperienceItem(
            ...
            'Nov 2025 - Present',
            [
              'Designed and developed a comprehensive school website using Flask, JavaScript, and HTML5/CSS3',
              'Implemented secure payment integrations for M-Pesa Paybill and Bank Account payments',
              'Integrated character development tracking and academic program visuals',
              'Successfully tested and deployed the platform to a production environment (Hostnali)',
              'Focused on creating a responsive and user-friendly experience for parents and community members',
            ],
          ),
          const SizedBox(height: 20),
          _buildExperienceItem(
