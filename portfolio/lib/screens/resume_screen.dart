        ...
        children: [
          ...
          _buildExperienceItem(
            ...
            [
              ...
              'Implementing state management solutions (Provider, Bloc)',
              'Integrating REST APIs and third-party services',
              'Collaborating with clients to deliver high-quality applications',
          ...
          _buildExperienceItem(
            ...
            'Nov 2025 - Present',
            [
              'Designing and developing a comprehensive school website using Flask, JavaScript, and HTML5/CSS3',
              'Implementing secure payment integrations for M-Pesa Paybill and Bank Account payments',
              'Integrating character development tracking and academic program visuals',
              'Testing and deploying the platform to a production environment (Hostnali)',
              'Focusing on creating a responsive and user-friendly experience for parents and community members',
            ],
          ),
          const SizedBox(height: 20),
          _buildExperienceItem(
            ...
            [
              ...
              'Developing e-commerce platforms and business websites',
              'Implementing user authentication and database management',
              'Expanding backend services and continuously improving current features',
              'Optimizing website performance and SEO',
              'Collaborating with clients to deliver high-quality web solutions',
            ],
          ),
          const SizedBox(height: 20),
          _buildExperienceItem(
            ...
            'Dec 2019 - Sep 2020',
            [
              'Assisted senior developers in testing web functionality and identifying bugs',
              'Supported the customer care team with call handling, email follow-ups, and proactive outreach',
              'Aided the accounting department in updating financial records and reimbursement sheets using Excel',
              'Maintained and updated organizational records to ensure data accuracy and integrity',
              'Demonstrated versatility by contributing across technical, customer service, and administrative departments',
            ],
          ),
        ],
      ),
